...
👉**SAMPLE**
+ **All caps**(모두 대문자)
![All caps](https://github.com/crazyjamy/crazyjamy.github.io/blob/master/_images/_post/icon_naming/all_caps.png?raw=true)
+ **Small caps**(모두 대문자지만 사이즈는 소문자랑 같음)
![Small caps](https://github.com/crazyjamy/crazyjamy.github.io/blob/master/_images/_post/icon_naming/all_lower_case.png?raw=true)
+ **All lower case**(모두 소문자)
![All lower case](https://github.com/crazyjamy/crazyjamy.github.io/blob/master/_images/_post/icon_naming/small_caps.png?raw=true)
