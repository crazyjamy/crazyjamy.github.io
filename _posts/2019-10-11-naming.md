...
형식은 lowerCamelCase와 같지만,  데이터 타입에 따라 접두사(prefix)로 나타내는 방식입니다. 마쏘(microsoft)에서 많이 사용 되었다지만, 요즘은 잘 사용이 안된다고 한다. 근데 내가 쓰는 네이밍 규칙이 이곳에서 어느정도 영향을 받지 않았나... 생각도 든다. 
...
- [김피자님의브런치](https://brunch.co.kr/@pizzakim/26) 
